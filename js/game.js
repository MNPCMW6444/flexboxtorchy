var game = {
  ...
  setHandlers: function () {
    $("#next").on("click", function () {
      ...
      $(".torch").addClass("animated bounceOutUp");
    ...
    $("#colorblind").on("change", function () {
      ...
      if (game.colorblind == "true") {
        $(".lilypad, .torch").addClass("cb-friendly");
      } else {
        $(".lilypad, .torch").removeClass("cb-friendly");
      }
    });
    ...
    $(window)
      ...
      .on("hashchange", function () {
        ...
        $("#tweet iframe").remove();
        var html =
          '<a href="https://twitter.com/share" class="twitter-share-button"{count} data-url="https://flexboxtorchy.com" data-via="thomashpark">Tweet</a> ' +
  ...
  loadLevel: function (level) {
    ...
    for (var i = 0; i < string.length; i++) {
      ...
      var torch = $("<div/>")
        .addClass(
          "torch " + color + (this.colorblind == "true" ? " cb-friendly" : "")
        )
        .data("color", color);

      $("<div/>").addClass("bg").css(game.transform()).appendTo(lilypad);
      $("<div/>").addClass("bg animated pulse infinite").appendTo(torch);
  ...
  check: function () {
    ...
    $(".lilypad").each(function () {
      ...
      if (!(key in torchs) || torchs[key] !== val) {
        correct = false;
      }
    });
  ...
  win: function () {
    ...
    $("#code").val(solution);
    $("#share").show();
    $(".torch .bg").removeClass("pulse").addClass("bounce");
  },
