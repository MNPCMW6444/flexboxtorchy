var messages = {
  ...
  labelFooter: {
    en: "Flexbox torchy is created by",
    he: "Flexbox torchy נוצר על ידי",
    ro: "Flexbox torchy este creat de",
    sr: "Flexbox torchy је направио",
    bs: "Flexbox torchy je napravio",
    bg: "Flexbox torchy е създадена от",
    de: "Flexbox torchy wurde gemacht von",
    fr: "Flexbox torchy est créé par",
    "pt-br": "Flexbox torchy foi criado por",
    es: "Flexbox torchy es una creación de",
    ru: "Игра Flexbox torchy создана",
    fa: "قورباغه فلکس باکس ساخته شده توسط",
    "zh-cn": "Flexbox torchy的作者是",
    "zh-tw": "Flexbox torchy的作者是",
    tr: "Flexbox torchy'nin yaratıcısı:",
    it: "Flexbox torchy è stato creato da",
    ko: "Flexbox torchy는 다음에 의해 개발되었습니다",
    lt: "Flexbox torchy kūrėjas",
    vi: "Flexbox torchy được tạo ra bởi",
    pl: "Flexbox torchy jest wytworem",
    cs: "Flexbox torchy vytvořil",
    ja: "Flexbox torchy is created by",
    hu: "A Flexbox torchy-t készítette",
    eo: "Flexbox torchy far",
    sv: "Flexbox torchy skapades av",
    uk: "Гру Flexbox torchy створено",
    hi: "Flexbox torchy के निर्माणकर्ता ",
    nl: "Flexbox torchy is gemaakt door",
    ta: "Flexbox torchy உருவாக்கியவர்",
    te: "Flexbox torchy చేసిన వారు",
    ml: "Flexbox torchy സൃഷ്ടിച്ചത്",
    el: "Το Flexbox torchy δημιουργήθηκε από",
    mk: "Flexbox torchy е создадено од",
    lv: "Flexbox torchy autori ir",
    id: "Flexbox torchy dibuat oleh",
    ar: "تم انشاء فروغي فلكسبكس بواسطة",
    ca: "Flexbox torchy és una creació de",
    da: "Flexbox torchy er skabt af",
    et: "Flexbox torchy on looja on",
    fi: "Flexbox torchyn on tehnyt",
    gl: "Flexbox torchy creouno",
  },
  labelLevel: {
    en: "Level",
    he: "שלב",
  ...
  title: {
    en: "Flexbox torchy - A game for learning CSS flexbox",
    he: "Flexbox torchy - משחק ללמידת CSS flexbox",
    ro: "Flexbox torchy - Un joc pentru a învăța CSS flexbox",
    sr: "Flexbox torchy - Игра за учење CSS flexbox-а",
    bs: "Flexbox torchy - Igra za učenje CSS flexbox-a",
    bg: "Flexbox torchy - Игра за учене на CSS flexbox",
    de: "Flexbox torchy - Ein Spiel, um CSS flexbox zu lernen",
    fr: "Flexbox torchy - Un jeu pour apprendre les flexbox CSS",
    "pt-br": "Flexbox torchy - Um jogo para aprender CSS flexbox",
    es: "Flexbox torchy - Un juego para aprender CSS flexbox",
    ru: "Flexbox torchy - Игра для изучения CSS Flexbox",
    fa: "قورباغه فلکس باکس - یک بازی جذاب برای آموزش سی اس اس فلکس باکس",
    "zh-cn": "Flexbox torchy - 一个用来学CSS flexbox的游戏",
    "zh-tw": "Flexbox torchy - 一個用來學CSS flexbox的遊戲",
    tr: "Flexbox torchy - CSS flexbox için öğretici oyun",
    it: "Flexbox torchy - Un gioco per imparare CSS flexbox",
    ko: "Flexbox torchy - CSS flexbox 속성 배우기 게임",
    lt: 'Flexbox torchy - Žaidimas padėsiantis perprasti CSS "flexbox" metodiką',
    vi: "Flexbox torchy - Một trò chơi để học CSS flexbox",
    pl: 'Flexbox torchy - Gra wprowadzająca do CSS flexbox"',
    cs: "Flexbox torchy - CSS flexbox hrou",
    ja: "Flexbox torchy - CSS flexbox学習ゲーム",
    hu: "Flexbox torchy - Játékos CSS flexbox tanulás",
    eo: "Flexbox torchy - Ludo por lerni CSS flexbox-on",
    sv: "Flexbox torchy - Ett spel för att lära sig CSS flexbox",
    uk: "Flexbox torchy - гра для вивчення CSS flexbox",
    hi: "Flexbox torchy - CSS Flexbox सीखने के लिए एक खेल",
    nl: "Flexbox torchy - Een spel om CSS flexbox te leren",
    ta: "Flexbox torchy - CSS flexbox கற்றல் விளையாட்டு",
    te: "Flexbox torchy - CSS Flexbox నేర్చుకోవడానికి ఒక ఆట",
    ml: "Flexbox torchy - CSS Flexbox പഠിക്കാം",
    el: "Flexbox torchy - Ένα παιχνίδι για την εκμάθηση του CSS Flexbox",
    mk: "Flexbox torchy - Игра за учење на CSS flexbox",
    lv: "Flexbox torchy - Spēle, kas Tev palīdzēs iemācīties CSS Flexbox",
    id: "Flexbox torchy - Sebuah permainan untuk belajar CSS flexbox",
    ar: "فروغي فلكسبكس - لعبة لتعلم الفلكسبكس في CSS",
    ca: "Flexbox torchy - Un joc per aprendre CSS Flexbox",
    da: "Flexbox torchy - Et spil, der lærer dig CSS Flexbox",
    et: "Flexbox torchy - Mäng CSS flexbox'i õppimiseks",
    fi: "Flexbox torchy – Peli, jossa opit CSS flexbox -asettelun",
    gl: "Flexbox torchy - Un xogo para aprenderes CSS Flexbox",
  },
  labelReset: {
    en: "Reset",
    he: "איפוס",
